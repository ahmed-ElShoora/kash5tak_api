            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="{{Route('admin.images')}}">
                        <i class="iconsminds-home-3"></i>
                        <span>الصور</span>
                    </a>
                </li>
                <li>
                    <a href="{{Route('privacy.policy.update')}}">
                        <i class="iconsminds-police"></i>
                        <span>اعدادات الخصوصية</span>
                    </a>
                </li>
                <li>
                    <a href="{{Route('privacy.policy.sala.update')}}">
                        <i class="iconsminds-police"></i>
                        <span> اعدادات الخصوصية للسله</span>
                    </a>
                </li>
            </ul>
        </div>
